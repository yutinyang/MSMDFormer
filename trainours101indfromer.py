...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/ade20k/ade20k_spnet101_oursc55.yaml', help='config file')
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.arch == 'spnet':
        ...
        from models.lfwpoolingnetc55anindformer import LFWNet

        model = LFWNet(nclass=args.classes, backbone=args.backbone, pretrained=args.weight, criterion=criterion, norm_layer=BatchNorm, spm_on=args.spm_on)
