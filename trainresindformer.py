...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/ade20k/ade20k_spnet101our.yaml', help='config file')
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    args.weight='/root/data2/Projects/ICCV2023/NIPS2023/nips23/SPNet-master/pretrained/pretrained/resnet101-2a57e44d.pth'
    # args.weight='/root/data2/Projects/ICCV2023/NIPS2023/nips23/SPNet-master/pretrained/pretrained/resnet50-25c4b509.pth'
    if args.arch == 'spnet':
        from models.spnetandindformer import SPNet
    ...
    args.save_path='/root/data2/Projects/ICCV2023/NIPS2023/SPNet-master/exp/ade20k/spnet101/model'
    if main_process():
    ...
    train_data = None
    args.data_root='/root/data1/data/ade2/ADEChallengeData2016'
    args.train_list='/root/data2/Projects/ICCV2023/NIPS2023/nips23/SPNet-master/data/ADE20K/train.txt'
    args.test_list = '/root/data2/Projects/ICCV2023/NIPS2023/nips23/SPNet-master/data/ADE20K/val.txt'
